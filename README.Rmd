...
This package is intended to be used with <b>RStudio 2026.08</b> or newer<br>
and <b>R 4.6.1</b> or newer.<br>
</font>
...
This function downloads or updates **hunspell** spelling-checking dictionaries (including Lithuanian) that can be used by RStudio or by tools from the **wellspell.addin** package.
...
[Code Snippets](https://support.posit.co/hc/en-us/articles/204463668-Code-Snippets){target="_blank"} in RStudio and on package
