...
Tested only on *Windows 10* (64-bit) with RStudio 1.2.5033.
</font>
<br><br>
</center>

Bug reports and your feedback are wellcome at https://github.com/mokymai/bio/issues.
In the report, indicate your operating sistem.
...
By defaul, only missing packages or packages with lower than recommended versions are displayed.
...
> You may use functions that reset keybindings, RStudio settings and snippets **at your own risk**.
...
<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>'</kbd>                 | Insert quotes `“`.
<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>P"       | Align selected lines at pattern.
<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>A"       | Use "Tidyverse" style on selected lines of R code (R code).
<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>S"       | Check spelling in selected text (if package **wellspell.addin** is installed).
