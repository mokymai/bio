...
This package is well tested on <em>Windows 10</em> (64-bit) with RStudio 1.2.5033 only.
</font>
<br><br>
</center>
...
- `"bio-default"`{.r} -- shortcut keys, recommended for BS-2020.
...
: **Table 1.** Some of shortcut keys set with option `"bio-default"`{.r}.
...
- `"bio-default"`{.r} -- options recommended for course BS-2020.
