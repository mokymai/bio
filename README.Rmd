...
Convenience functions to facilitate installation and management of required resources for course units __*Biostatistics*__  (*BS-2020*) and __*Introduction to data analysis with R*__ (*R-2020*).
...
> The functions in this sub-section may **not** work correctly with the newest versions of RStudio (vesion > 1.3.0).
