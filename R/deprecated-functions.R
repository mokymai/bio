...
read_rs_user_settings <- function(...) {
  .Deprecated("bio::rstudio_read_user_settings()")
...
read_rs_ui_prefs <- function(...) {
  .Deprecated("bio::rstudio_read_ui_prefs()")
...
get_rs_ui_prefs <- function(...) {
  .Deprecated("bio::rstudio_get_ui_prefs()")
...
get_rs_user_settings_names <- function(...) {
  .Deprecated("bio::rstudio_get_user_setting_names()")
...
get_rs_ui_pref_names <- function(...) {
  .Deprecated("bio::rstudio_get_ui_pref_names()")
